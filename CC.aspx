<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="CC.aspx.cs" Inherits="CC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table style="width: 100%;">
        <tr>
            <td class="style2">
                &nbsp;
                <asp:Button ID="btnUnsetDef" runat="server" OnClick="btnUnsetDef_Click" Text="Unset Default" />
            </td>
        ...
        <tr>
            <td class="style2">
                &nbsp;
                <asp:Button ID="btnSetDef" runat="server" OnClick="btnSetDef_Click" Text="Set Default" />
            </td>
            <td class="style1" colspan="2">
        ...
        <tr>
            <td class="style3">
                &nbsp;
                <asp:Button ID="btnAddLoc" runat="server" Height="31px" OnClick="btnAddLoc_Click"
                    Text="Add Location" Width="118px" />
            </td>
            <td align="center" class="style3">
                <asp:Button ID="btnRemLoc" runat="server" Height="28px" OnClick="btnRemLoc_Click"
                    Text="Remove Location" Width="118px" />
            </td>
            <td class="style3">
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="btneditloc" runat="server" Height="30px" OnClick="btneditloc_Click"
                    Text="Edit Location" Width="114px" />
            &nbsp;&nbsp;&nbsp;
            </td>
            <td class="style3">
                &nbsp;
        ...
        <tr>
            ...
            <td class="style1" colspan="2" rowspan="2">
                <asp:TextBox ID="txtNewLoc" runat="server" OnTextChanged="txtNewLoc_TextChanged"

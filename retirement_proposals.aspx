<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="retirement_proposals.aspx.cs" Inherits="frmproposalmenu" %>
        ...
        <tr>
            <td class="style2" align="center" colspan="3">
                            <asp:Label ID="Label5" runat="server" Font-Size="Large" ForeColor="#3333CC" 
                                Text="Retirement Proposals"></asp:Label>
                        </td>
        </tr>
        <tr>
            <td class="style2">
            ...
            <td class="style3">
                <asp:Panel ID="panNewProp" runat="server">
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:DropDownList ID="drpRetType" runat="server">
                                    <asp:ListItem Selected="True" Value="S">Supperannuation</asp:ListItem>
